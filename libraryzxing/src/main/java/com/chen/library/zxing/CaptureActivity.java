package com.chen.library.zxing;
...
import com.chen.library.zxing.camera.CameraManager;
import com.chen.library.zxing.decoding.CaptureActivityHandler;
import com.chen.library.zxing.decoding.InactivityTimer;
import com.chen.library.zxing.utils.ZXingUtils;
import com.chen.library.zxing.view.ViewfinderView;
import com.chen.libraryzxing.R;
...
public class CaptureActivity extends Activity implements Callback, OnClickListener {
    ...
    private void SaveImage(final String photoPath) throws IOException {
        ...
        if (file.exists()){
            ...
            if (Environment.MEDIA_MOUNTED.equals(state)) {
                ...
                Log.d(TAG, "SaveImage: can not write");
            }
        }else {
            Log.d(TAG, "SaveImage: NO file");
        }
    }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (TextUtils.isEmpty(result)) {
                            ...
                            //
                            data.putExtra(ZXingConstants.Scanphotopath,photoPath);
                            //
